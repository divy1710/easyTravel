      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-gray-700 text-sm font-medium">AI-Powered Travel Planning</span>
          </motion.div>
          ...
          {/* Subheading */}
          <p className="text-base md:text-lg text-white/95 max-w-2xl mx-auto mb-10 leading-relaxed drop-shadow-md">
